...
<head>
	...
	<title>AFS Timesheet aplication | Login</title>
	

	<link rel="stylesheet" href="<?php echo base_url(); ?>template/assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>template/assets/css/font-icons/entypo/css/entypo.css">
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic">
	<link rel="stylesheet" href="<?php echo base_url(); ?>template/assets/css/bootstrap.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>template/assets/css/neon-core.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>template/assets/css/neon-theme.css">
...
<div class="login-container">
	...
	<div class="login-header login-caret" style="background-color:#FFF;">
		
		<div class="login-content">
			
			<a href="index.html" class="logo">
				<img src="<?php echo base_url(); ?>template/assets/images/afs.jpg"  alt="" />
			</a>
			
			<p class="description">Timesheet application</p>
	...
	<script src="<?php echo base_url(); ?>template/assets/js/neon-login.js"></script>
