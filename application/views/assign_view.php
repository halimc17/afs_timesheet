						...
						<div class="row">
							<div class="col-md-6">	
								<div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
									...
									<!-- panel body -->
									<div class="panel-body">
										<?php if (isset($records_matter)) {
											foreach($records_matter as $row){
												$id_matter = $row->id_matter;
												$matter = $row->matter;
												$openDate = $row->open_date;
												$closeDate = $row->close_date;
												$client = $row->nama_client;
											}
										} ?>
										<div class="row">
											<div class="col-md-12">						
										...
										<div class="row">
											<div class="col-md-6">						
												<div class="form-group">
													...
													<input type="text" class="form-control" id="txt_open_date" name="txt_open_date" value="<?php echo $openDate; ?>">
												</div>						
											</div>
											...
											<div class="col-md-6">						
												<div class="form-group">
													...
													<input type="text" class="form-control" id="txt_close_date" name="txt_close_date" value="<?php echo $closeDate; ?>">
												</div>						
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<button type="button" class="btn btn-default" data-dismiss="modal" onclick="location.href='<?php echo site_url('matter/'); ?>'">DONE</button>
